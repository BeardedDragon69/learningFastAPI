...
#               if username in None or userId is None:
...
# async def createUser(db: dbDependencyInjection, 
...
# SECRET_KEY = 'THis_iS_My_SeCret_Key_WShich_I_Will_Use_in_this_8q7623894576'
# ALGORITHM = 'HS256'
...
def create_access_token(username: str, user_id: int, role: str, expires_delta: timedelta):
    ...
    encode.update({'exp': expires})
    return jwt.encode(encode, '5d2a96f5a3c09d21bed21b7f11c9e94a70f943b3d381d4f7906a5e51de8165c8', algorithm=["HS256"])
...
async def get_current_user(token: Annotated[str, Depends(oauth2_bearer)]):
    try:
        payload = jwt.decode(token, '5d2a96f5a3c09d21bed21b7f11c9e94a70f943b3d381d4f7906a5e51de8165c8', algorithm=["HS256"], options={"verify_exp": False})
        username: str = payload.get('sub')
